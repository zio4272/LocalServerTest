...
import kr.co.zio4272.localservertest.util.HttpRequest;
            ...
            AsyncTaskHandler async = new AsyncTaskHandler() {
                ...
                public String doInBackground() {
                    ...
                    if (params == null)
                        ...
                        Log.d("GET URL", sb.toString());

                        return HttpRequest.get(sb.toString()).body();
                    }
                }
            };
